...
@JacksonXmlRootElement(localName = "TilingScheme")
public class TilingSchemeDetailDocument {

    private final GeoServer geoServer;
    private final GridSet gridSet;

    public TilingSchemeDetailDocument(GeoServer geoServer, GridSet gridSet) {
