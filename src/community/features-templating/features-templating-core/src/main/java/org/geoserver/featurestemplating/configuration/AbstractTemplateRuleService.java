...
/** Abstract class that provides methods to add, update or delete Template Rules. */
public class AbstractTemplateRuleService {

    private final FeatureTypeInfo featureTypeInfo;
    private final String metadataKey;

    public AbstractTemplateRuleService(FeatureTypeInfo featureTypeInfo, String metadataKey) {
    ...
    public boolean removeRule(String ruleId) {
        ...
        if (rules != null && !rules.isEmpty()) {
            ...
            if (result) {
                ...
                featureTypeInfo.getMetadata().put(metadataKey, config);
    ...
    private TemplateLayerConfig getTemplateLayerConfig() {
        return featureTypeInfo.getMetadata().get(metadataKey, TemplateLayerConfig.class);
    }
