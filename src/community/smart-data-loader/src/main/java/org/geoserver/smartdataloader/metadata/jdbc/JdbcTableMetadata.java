    ...
    public List<AttributeMetadata> getAttributes() {
        try {
            ...
            if (attributes.isEmpty()) {
                attributes.addAll(DefaultJdbcHelper.getInstance().getColumnsByTable(connection.getMetaData(), this));
            }
            return attributes;
        } catch (Exception e) {
    ...
    public List<RelationMetadata> getRelations() {
        try {
            if (relations.isEmpty()) {
                relations.addAll(DefaultJdbcHelper.getInstance().getRelationsByTable(connection.getMetaData(), this));
            }
            return relations;
        } catch (Exception e) {
