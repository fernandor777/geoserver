...
public class AttributeGlobeFonts {
     ...
     * @param valueFontName font name for values, can be null and the same font name as title will be used
     * @param titleColorCode color hex RGB code for titles
     * @param valueColorCode color hex RGB code for values. Can be null and the same color as titles will be used
     */
    public AttributeGlobeFonts(int fontSize, String titleFontName, 
            String valueFontName, String titleColorCode,
        ...
        this.valueColor = Color.decode(
                valueColorCode != null ? valueColorCode : titleColorCode);
    }
    ...
    public static AttributeGlobeFonts getDefault() {
        return new AttributeGlobeFonts(10, "Serif", null, "#000000", null);
    }
}
